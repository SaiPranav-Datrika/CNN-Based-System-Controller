...
myFiveTrainImageFiles = glob.glob(r"C:/Users/sai pranav/Desktop/Dataset/fiveFingerTrainDataset/*.jpg")
...
myZeroTrainImageFiles = glob.glob(r"C:/Users/sai pranav/Desktop/Dataset/zeroFingerTrainDataset/*.jpg")
...
#myGes3TrainImageFiles = glob.glob("C:/Users/sai pranav/Desktop/Dataset/gesture3Train/*.jpg")
...
#myGes4TrainImageFiles = glob.glob("C:/Users/sai pranav/Desktop/Dataset/gesture4Train/*.jpg")
...
myFiveTestImageFiles = glob.glob(r"C:/Users/sai pranav/Desktop/Dataset/fiveFingerTestDataset/*.jpg")
...
myZeroTestImageFiles = glob.glob((r"C:/Users/sai pranav/Desktop/Dataset/fiveFingerTestDataset/*.jpg"))
...
#myGes3TestImageFiles = glob.glob("C:/Users/sai pranav/Desktop/Dataset/gesture3Test/*.jpg")
...
# load testing data for gesture 4 (RANDOM)
#myGes4TestImageFiles = glob.glob("C:/Users/sai pranav/Desktop/Dataset/gesture4Test/*.jpg")
...
x_test = x_test / 255
#============== Change 1 ====================================#
'''Changed Encoding of 5 fingers to 1'''

y_train = numpy.array(list(map(lambda X : 1 if(int(X)==5) else 0,y_train)))
y_test = numpy.array(list(map(lambda X : 1 if(int(X)==5) else 0,y_test)))
...
def baseline_model():
   ...
   model = Sequential()
   model.add(
       Conv2D(32, (5, 5), input_shape=(1, imageSize, imageSize), data_format='channels_first', activation='relu'))
...
model.save_weights(r"C:/Users/sai pranav/Desktop/modelWeights.h5")
